...
class CalloutServer:
  ...
  def __init__(
      ...
      # cert_chain_path: str | None = 'E:\Projects\SEC\Python\service-extensions-samples\callouts\python\extproc\ssl_creds\chain.pem',
      private_key: bytes | None = None,
      private_key_path: str = './extproc/ssl_creds/privatekey.pem',
      # private_key_path: str = 'E:\Projects\SEC\Python\service-extensions-samples\callouts\python\extproc\ssl_creds\privatekey.pem',
